...
Basados en estas evidencias Robertson y colaboradores proponen el modelo del Doble Filtro por Frecuencias\todo{ver como lo puse en otro lados} [\cite{robertson_hemispheric_2000}]. En este modelo el sistema visual selecciona un rango de operación en el espacio de frecuencias espaciales, de acuerdo con la escena visual a analizar, y después distribuye la información a los dos hemiferios: la banda de frecuencias más altas al hemisferio izquierdo y la banda de frecuencias más bajas al hemisferio derecho. Este modelo explicaría muchos de los hallazgos descritos arriba. Sin embargo, no postula un mecanismo en términos de circuitos neurales que puedan implementar las operaciones implicadas. El desarrollo de técnicas para estudiar el sistema visual con fMRI abre la posibilidad de identificar los circuitos neurales relevantes, tema que se aborda en la próxima sección.
