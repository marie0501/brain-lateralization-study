...
\advisor{\\\vspace{0.25cm}Dr. Mitchell Valdes-Sosa\\\vspace{0.2cm}Nombre del segundo tutor}
...
\include{MainMatter/State_of_the_art}
\include{MainMatter/Theory}
\include{MainMatter/Materials_and_methods}
